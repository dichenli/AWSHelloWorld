 ...
 */
public class PopulateWordCount {
	
	static AmazonDynamoDBClient dynamoDB; //DB, collection of tables
	static String tableName = "WordCount"; //self defined table name. new table will be created if not exists
	static String keyName = "LineNum"; //self defined name for the table key
	static ScalarAttributeType keyType = ScalarAttributeType.S; //http://docs.aws.amazon.com/amazondynamodb/latest/developerguide/DataModel.html
	...
	public static void main(String[] args) throws Exception {
        ...
        try {
            String tableName = PopulateWordCount.tableName;
